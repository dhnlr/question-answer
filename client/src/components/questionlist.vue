      ...
      <article class="media">
        <div class="media-left">
          <p>
            ...
            <button class="like is-radiusless" @click="vote(question['_id'])" v-if="!islike(key) && token"></button>
            <button class="unlike is-radiusless" @click="vote(question['_id'])" v-if="islike(key) && token"></button>
          </p>
        </div>
